...
grep -Fq 'shellcheck --severity=warning dev-env-init/install.sh dev-env-init/bin/tu dev-env-init/bin/tu-wrapper dev-env-init/lib/*.sh dev-env-init/scripts/*.sh dev-env-init/tests/*.sh' "$CI_FILE"
