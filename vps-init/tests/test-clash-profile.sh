...
grep -Fq '  route-exclude-address:' "$profile"
grep -Fq '    - 10.0.0.0/8' "$profile"
grep -Fq '    - 100.64.0.0/10' "$profile"
grep -Fq '    - 169.254.0.0/16' "$profile"
grep -Fq '    - 172.16.0.0/12' "$profile"
grep -Fq '    - 192.168.0.0/16' "$profile"
grep -Fq '    - fc00::/7' "$profile"
grep -Fq '    - fe80::/10' "$profile"
